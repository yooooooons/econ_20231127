...
No_of_bought_items = 0   # 현재 매수 상태인 아이템 수

No_of_buyable_items = 3   # 동시에 매수 상태일수 있는 최대 종목 수
...
ETC_5_dic = {'type': 'type_2', 'coin_No': 'KRW-ETC', 'coin_Name': 'KRW-ETC', 'ma_duration_long': 102, 'ma_duration_mid': 30, 'ma_duration_short': 72, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 0.5, 'under_long_duration': 29, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.5, 'ratio_peak_diff': 0.006, 'ratio_open_check': 1.0027, 'ratio_reduced': 0.7, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.5, 'ratio_sell_forced': 0.07, 'bought_state': 0, 'bought_price': 0.0}

BTG_20_dic = {'type': 'type_2', 'coin_No': 'KRW-BTG', 'coin_Name': 'KRW-BTG', 'ma_duration_long': 102, 'ma_duration_mid': 33, 'ma_duration_short': 53, 'ratio_ema_long_rise': 1.0001, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0002, 'successive_rise': 7, 'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 26, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.5, 'ratio_peak_diff': 0.005, 'ratio_open_check': 1.0018, 'ratio_reduced': 0.7, 'ratio_prior_to_cur_long': 0.993, 'ratio_mean_long': 0.5, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0}

ARK_14_dic = {'type': 'type_2', 'coin_No': 'KRW-ARK', 'coin_Name': 'KRW-ARK', 'ma_duration_long': 89, 'ma_duration_mid': 26, 'ma_duration_short': 63, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0, 'successive_rise': 8, 'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 42, 'recent_vol_duration': 13, 'sell_method_vol_cri': 0.6, 'ratio_peak_diff': 0.006, 'ratio_open_check': 1.0029, 'ratio_reduced': 0.8, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.0, 'ratio_sell_forced': 0.06, 'bought_state': 0, 'bought_price': 0.0}

WAXP_57_dic = {'type': 'type_2', 'coin_No': 'KRW-WAXP', 'coin_Name': 'KRW-WAXP', 'ma_duration_long': 100, 'ma_duration_mid': 23, 'ma_duration_short': 69, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0003, 'recent_ratio_ema_long_plus': 0.0001, 'successive_rise': 8, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 0.5, 'under_long_duration': 37, 'recent_vol_duration': 8, 'sell_method_vol_cri': 0.3, 'ratio_peak_diff': 0.006, 'ratio_open_check': 1.0016, 'ratio_reduced': 0.7, 'ratio_prior_to_cur_long': 0.997, 'ratio_mean_long': 0.7, 'ratio_sell_forced': 0.04, 'bought_state': 0, 'bought_price': 0.0}

QTUM_9_dic = {'type': 'type_2', 'coin_No': 'KRW-QTUM', 'coin_Name': 'KRW-QTUM', 'ma_duration_long': 89, 'ma_duration_mid': 33, 'ma_duration_short': 77, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0001, 'successive_rise': 10, 'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.005, 'diff_vol_aver': 1.0, 'under_long_duration': 39, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.4, 'ratio_peak_diff': 0.006, 'ratio_open_check': 1.003, 'ratio_reduced': 0.7, 'ratio_prior_to_cur_long': 0.994, 'ratio_mean_long': 0.4, 'ratio_sell_forced': 0.08, 'bought_state': 0, 'bought_price': 0.0}

BCH_30_dic = {'type': 'type_2', 'coin_No': 'KRW-BCH', 'coin_Name': 'KRW-BCH', 'ma_duration_long': 99, 'ma_duration_mid': 28, 'ma_duration_short': 70, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0.0001, 'successive_rise': 8, 'ratio_ema_mid_long': 0.98, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 1.0, 'under_long_duration': 51, 'recent_vol_duration': 8, 'sell_method_vol_cri': 0.9, 'ratio_peak_diff': 0.006, 'ratio_open_check': 1.002, 'ratio_reduced': 0.85, 'ratio_prior_to_cur_long': 0.995, 'ratio_mean_long': 0.3, 'ratio_sell_forced': 0.05, 'bought_state': 0, 'bought_price': 0.0}

BORA_72_dic = {'type': 'type_2', 'coin_No': 'KRW-BORA', 'coin_Name': 'KRW-BORA', 'ma_duration_long': 100, 'ma_duration_mid': 32, 'ma_duration_short': 62, 'ratio_ema_long_rise': 1.0, 'ratio_ema_mid_rise': 1.0004, 'recent_ratio_ema_long_plus': 0, 'successive_rise': 10, 'ratio_ema_mid_long': 0.99, 'ratio_vol_curr_prior': 1.0, 'diff_m_l_factor': 0.0, 'diff_vol_aver': 1.0, 'under_long_duration': 43, 'recent_vol_duration': 9, 'sell_method_vol_cri': 0.1, 'ratio_peak_diff': 0.006, 'ratio_open_check': 1.004, 'ratio_reduced': 0.7, 'ratio_prior_to_cur_long': 0.993, 'ratio_mean_long': 0.1, 'ratio_sell_forced': 0.08, 'bought_state': 0, 'bought_price': 0.0}
...
def type_0_buy_sell_normal (target_dic) :
    ...
    if target_dic['bought_state'] == 0 :   # 매수가 없는 상태라면 
        ...
        if (No_of_bought_items < No_of_buyable_items) and         (DF_check['ratio_ema_long'][-4] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-3] > target_dic['ratio_ema_long_rise']) and (DF_check['ratio_ema_long'][-2] > target_dic['ratio_ema_long_rise']) and         (DF_check['ratio_ema_long'][-1] > (target_dic['ratio_ema_long_rise'] + target_dic['recent_ratio_ema_long_plus'])) and (DF_check['ratio_ema_mid'][-1] > target_dic['ratio_ema_mid_rise']) and         (DF_check.iloc[-(target_dic['successive_rise'] + 2) : ]['rise_check_short'].sum() >= (target_dic['successive_rise'] - 2)) and         ((DF_check['ema_mid'][-1] / DF_check['ema_long'][-1]) > target_dic['ratio_ema_mid_long']) and         (DF_check['ref_vol_amount'][-2] >= target_dic['coe_vol_comp']) and (DF_check['ref_vol_amount'][-2] >= DF_check['ref_vol_amount'][-3]) and (DF_check['ref_vol_amount'][-2] >= DF_check['ref_vol_amount'][-4]) and         (-DF_check.loc[DF_check.iloc[-(target_dic['under_long_duration'] + 1) : -1]['diff_m_l'].idxmin()]['diff_m_l'] > (target_dic['diff_m_l_factor'] * DF_check['open'][-1])) :
            ...
            if No_of_bought_items == 0 :
                investable_budget = get_balance(check_currency) * buyable_budget_ratio_1
            elif No_of_bought_items == 1 :
                investable_budget = get_balance(check_currency) * buyable_budget_ratio_2
            elif No_of_bought_items == 2 :
                investable_budget = get_balance(check_currency) * buyable_budget_ratio_3
            ...
            if get_balance(coin_inv[4:]) > 0 :
                target_dic['bought_state'] = 1
                print ('bought_state_at after_bought_trial check : {0}'.format(target_dic['bought_state']))
                No_of_bought_items = No_of_bought_items + 1
    ...
    if target_dic['bought_state'] == 1 :   # 매수가 되어 있는 상태라면
        ...
        print ('DF_check_peak[low][-1] / DF_check_peak.loc[DF_check_peak.iloc[-(time_elapse_bought + 1) : -1][high].idxman()][high]) < (1 - target_dic[ratio_sell_forced_peak]) _____ {0} < {1}'.               format((DF_check_peak['low'][-1] / DF_check_peak.loc[DF_check_peak.iloc[-(time_elapse_bought + 1) : -1]['high'].idxman()]['high']), (1 - target_dic['ratio_sell_forced_peak'])))
        print ('DF_check_peak.iloc[-4 : -1][volume].maen() > (5 * DF_check_peak.iloc[-51 : -1][volume].mean()) _____ {0} > {1}'.               format(DF_check_peak.iloc[-4 : -1]['volume'].maen(), (5 * DF_check_peak.iloc[-51 : -1]['volume'].mean())))            
        
        if ((DF_check_peak['low'][-1] / DF_check_peak.loc[DF_check_peak.iloc[-(time_elapse_bought + 1) : -1]['high'].idxman()]['high']) < (1 - target_dic['ratio_sell_forced_peak'])) and         (DF_check_peak.iloc[-4 : -1]['volume'].maen() > (5 * DF_check_peak.iloc[-51 : -1]['volume'].mean())) :
...
def type_2_buy_sell_normal (target_dic) :
    ...
    if target_dic['bought_state'] == 1 :   # 매수가 되어 있는 상태라면
        ...
        print('Cheking Ratio_trend sell with coin :', target_coin)
        print('(time_elapse_bought > 3 _____ {0} > 3'.format(time_elapse_bought))
        print('(DF_check_peak.loc[DF_check_peak.iloc[-13 : -1][ratio_prior_to_cur].idxmax()][ratio_prior_fDF_check_peak.loc[DF_check_peak.iloc[-13 : -1][ratio_prior_to_cur].idxmax()][ratioto_cur] < target_dic[ratio_open_check]) _____ {0} < {1}'.              format(DF_check_peak.loc[DF_check_peak.iloc[-13 : -1]['ratio_prior_to_cur'].idxmax()]['ratio_prior_to_cur'], target_dic['ratio_open_check']))
        print('(DF_check_peak.iloc[-13 : -1][open].std() < (target_dic[ratio_reduced] * DF_check_peak.iloc[ -(time_elapse_bought + 4) : -(time_elapse_bought -2)][open].std())) _____ {0} < {1}'.              format(DF_check_peak.iloc[-13 : -1]['open'].std(), (target_dic['ratio_reduced'] * DF_check_peak.iloc[ -(time_elapse_bought + 4) : -(time_elapse_bought -2)]['open'].std())))
        print('DF_check_peak.iloc[-7 : -1][volume].mean() < (target_dic[ratio_reduced] * DF_check_peak.iloc[ -(time_elapse_bought + 4) : -(time_elapse_bought -2)][volume].mean()) _____ {0} < {1}'.              format(DF_check_peak.iloc[-7 : -1]['volume'].mean(), (target_dic['ratio_reduced'] * DF_check_peak.iloc[ -(time_elapse_bought + 4) : -(time_elapse_bought -2)]['volume'].mean())))
            
        if (time_elapse_bought > 3) and         (DF_check_peak.loc[DF_check_peak.iloc[-13 : -1]['ratio_prior_to_cur'].idxmax()]['ratio_prior_to_cur'] < target_dic['ratio_open_check']) and         (DF_check_peak.iloc[-13 : -1]['open'].std() < (target_dic['ratio_reduced'] * DF_check_peak.iloc[ -(time_elapse_bought + 4) : -(time_elapse_bought -2)]['open'].std())) and        (DF_check_peak.iloc[-7 : -1]['volume'].mean() < (target_dic['ratio_reduced'] * DF_check_peak.iloc[ -(time_elapse_bought + 4) : -(time_elapse_bought -2)]['volume'].mean())) :
